;(function (window) {
	...
	/* Expose the functions to the global namespace. */
	window.findRecordByElement = findRecordByElement;
	window.insertListener = insertListener;
	window.listenerExists = listenerExists;
